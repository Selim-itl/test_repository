...
class HelpDeskDashboard(http.Controller):
    ...
    def helpdesk_dashboard(self):
        ...
        in_mis = request.env["help.ticket"].search_count(
            [('stage_id', '=', stage_mis)])
        in_mis_id = request.env["help.ticket"].search(
            [('stage_id', '=', stage_mis)])
        ...
        cs = request.env["help.ticket"].search_count(
            [('stage_id', '=', stage_cs)])
        cs_id = request.env["help.ticket"].search(
            [('stage_id', '=', stage_cs)])
        ...
        verification_id = request.env["help.ticket"].search(
        ...
        correction_id = request.env["help.ticket"].search(
            [('stage_id', '=', stage_correction)])
